...
const HomePage = () => {
  ...
  const FilteredTitle = products?.filter((product) => (product.title.toLowerCase().includes(searchText.toLowerCase())))
...
return (
  <>
    ...
    <HomepageContainer>
      ...
      />
      <Section data={getCategory(FilteredTitle, "Jewelery")} title={FilteredTitle > 0 ? "Jewelery" : null} />
      <Section
